...
public class TestJsr303 extends AbstractClientValidationTest {
	...
	private final String ERROR_MESSAGE_ABOUT_SIZE_OF_NAME = 
	...
	private final String ERROR_MESSAGE_ABOUT_AGE_MUST_BE_GREATER_THAN = 
		"must be greater than or equal to 18";
	
	private final String ERROR_MESSAGE_ABOUT_AGE_MUST_BE_LESS_THAN = 
		"must be less than or equal to 99";
	
	private final String ERROR_MESSAGE_ABOUT_I_AGREE_THE_TERMS = 
		"must be true";
	...
	protected void isThereErrorMessageAboutSizeOfName(boolean shouldBeErrorMessagePresented) {
		...
		isThereErrorMessage(errorMessageAboutSizeOfName, ERROR_MESSAGE_ABOUT_SIZE_OF_NAME, shouldBeErrorMessagePresented);
	}
	...
	private void isThereErrorMessageAboutAgeGreaterThan(boolean shouldBeErrorMessagePresented) {
		...
		isThereErrorMessage(errorMessageAboutAgeMustBeGreaterThan, 
				ERROR_MESSAGE_ABOUT_AGE_MUST_BE_GREATER_THAN, shouldBeErrorMessagePresented);
	}
	...
	private void isThereErrorMessageAboutAgeLessThan(boolean shouldBeErrorMessagePresented) {
		...
		isThereErrorMessage(errorMessageAboutAgeMustBeLessThan, 
				ERROR_MESSAGE_ABOUT_AGE_MUST_BE_LESS_THAN, shouldBeErrorMessagePresented);
	}
	...
	private void isThereErrorMessageAboutCheckBox(boolean shouldBeErrorMessagePresented) {
		...
		isThereErrorMessage(errorMessageAboutIAgreeTheTerms, 
				ERROR_MESSAGE_ABOUT_I_AGREE_THE_TERMS, shouldBeErrorMessagePresented);
	}
