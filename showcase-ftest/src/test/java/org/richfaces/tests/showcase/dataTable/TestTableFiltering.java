...
public class TestTableFiltering extends AbstractDataIterationWithCars {
    ...
    public void testVendorFilter() {
        ...
        assertTrue(checkAllCarsAreCorrect(getPage().getCars(), Field.VENDOR, VENDOR_FILTER),
    ...
    public void testMileageFilter() {
        ...
        assertTrue(checkAllCarsAreCorrect(getPage().getCars(), Field.MILEAGE, MILEAGE_FILTER),
    ...
    public void testVinFilter() {
        ...
        assertTrue(checkAllCarsAreCorrect(getPage().getCars(), Field.VIN, VIN_FILTER), "all vins of the car should contain "
            + VIN_FILTER);
    }
    ...
    public void testNoRowsSatisfyConditions() {
        ...
        assertTrue(getPage().isNothingFound(), "No rows should satisfy the filter conditions");
    }
