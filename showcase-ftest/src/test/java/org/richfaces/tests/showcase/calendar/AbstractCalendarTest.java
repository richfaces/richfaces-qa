...
public class AbstractCalendarTest extends AbstractShowcaseTest {
	 ...
	 * 
	 * @param setOfComponents the set of components
	 * 
	 * @param shouldBeVisible whether the components in the set should be visible or not
	 */
	...
	/**
	 * Checks whether there are all components when the calendar is visible, and that there are non when it is not visible
	 */
	 ...
	 * 
	 * @param componentType the type of the disabled component
	 */
