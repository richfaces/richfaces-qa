...
public class TestImgUsage extends AbstractGrapheneTest {
    ...
    private void testTheImage(long expectedRightBottomCornerColor, long expectedLeftTopCornerColor,
        ...
        assertEquals(bufferedImage.getRGB(0, 0), expectedLeftTopCornerColor, "The top-left corner should be different");
        assertEquals(bufferedImage.getRGB(widthOfImage - 1, heightOfImage - 1), expectedRightBottomCornerColor,
            "The bottom-right corner should be different");
        assertEquals(bufferedImage.getRGB(95, 45), expectedTextColor, "The text color should be different");
    }
