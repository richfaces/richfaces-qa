...
public class TestTableSorting extends AbstractDataIterationWithStates {
	 ...
	 *Constants 
	 *******************************************************************************************************/
	private final StateWithCapitalAndTimeZone FIRST_STATE_SORTED_BY_CAPITAL_ASCENDING_ORDER =
		new StateWithCapitalAndTimeZone("New York", "Albany", "GMT-5");
	
	private StateWithCapitalAndTimeZone FIRST_STATE_SORTED_BY_CAPITAL_DESCENDING_ORDER =
		new StateWithCapitalAndTimeZone("New Jersey", "Trenton", "GMT-5");
	
	private StateWithCapitalAndTimeZone FIRST_STATE_SORTED_BY_STATE_ASCENDING_ORDER =
		new StateWithCapitalAndTimeZone("Alabama", "Montgomery", "GMT-6");
	
	private StateWithCapitalAndTimeZone FIRST_STATE_SORTED_BY_STATE_DESCENDING_ORDER =
		new StateWithCapitalAndTimeZone("Wyoming", "Cheyenne", "GMT-7");
	
	private StateWithCapitalAndTimeZone FIRST_STATE_SORTED_BY_TIME_ZONE_ASCENDING_ORDER =
		new StateWithCapitalAndTimeZone("Hawaii", "Honolulu", "GMT-10");
	
	private StateWithCapitalAndTimeZone FIRST_STATE_SORTED_BY_TIME_ZONE_DESCENDING_ORDER =
		new StateWithCapitalAndTimeZone("Connecticut", "Hartford", "GMT-5");
	...
	public void testSortByCapitalName() {
		...
		clickOnParticularSortAnchorCheckFirstRow(sortByCapitalName, 
				FIRST_STATE_SORTED_BY_CAPITAL_ASCENDING_ORDER, FIRST_STATE_SORTED_BY_CAPITAL_DESCENDING_ORDER, 
	...
	public void testSortByStateName() {
		...
		clickOnParticularSortAnchorCheckFirstRow(sortByStateName, 
				FIRST_STATE_SORTED_BY_STATE_ASCENDING_ORDER, FIRST_STATE_SORTED_BY_STATE_DESCENDING_ORDER, 
	...
	public void testSortByTimeZone() {
		...
		clickOnParticularSortAnchorCheckFirstRow(sortByTimeZone, 
				FIRST_STATE_SORTED_BY_TIME_ZONE_ASCENDING_ORDER, FIRST_STATE_SORTED_BY_TIME_ZONE_DESCENDING_ORDER, 
	...
	private void clickOnParticularSortAnchorCheckFirstRow(JQueryLocator sortBy, 
			StateWithCapitalAndTimeZone ascendingState, StateWithCapitalAndTimeZone descendingState,
			String ascendingError, String descendingError) {
	...
	private StateWithCapitalAndTimeZone initializeStateDataFromRow() {
		...
		for( Iterator<JQueryLocator> iterator = tds.iterator(); iterator.hasNext(); ) {
			...
			switch(i) {
				case 1: capitalName = selenium.getText(currentTd); break;
				case 2: stateName = selenium.getText(currentTd); break;
				case 3: timeZone = selenium.getText(currentTd); break;
				default: break;
			}
