...
public class TestWizard extends AbstractAjocadoTest {
	...
	protected final String ERROR_MSG_FIRST_NAME = "First Name: "
			+ ERROR_MSG_VALUE_REQUIRED;
	protected final String ERROR_MSG_LAST_NAME = "Last Name: "
			+ ERROR_MSG_VALUE_REQUIRED;
	protected final String ERROR_MSG_COMPANY = "Company: "
			+ ERROR_MSG_VALUE_REQUIRED;
	protected final String ERROR_MSG_NOTES = "Notes: "
			+ ERROR_MSG_VALUE_REQUIRED;
	...
	private void checkForAllErrorMessagesFromFirstStep(
			boolean shouldErrorMessagePresented) {

		isThereErrorMessage(errorMessageFirstName, ERROR_MSG_FIRST_NAME,
				shouldErrorMessagePresented);

		isThereErrorMessage(errorMessageLastName, ERROR_MSG_LAST_NAME,
				shouldErrorMessagePresented);

		isThereErrorMessage(errorMessageCompany, ERROR_MSG_COMPANY,
				shouldErrorMessagePresented);
	}
