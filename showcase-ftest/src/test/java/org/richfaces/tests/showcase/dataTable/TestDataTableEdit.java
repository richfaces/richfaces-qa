...
public class TestDataTableEdit extends AbstractDataIterationWithCars {
    ...
    public void testDeleteCarCancelButton() {
        ...
        assertTrue(containsTableParticularCar(car), "The table should contain this car " + car
            + ", since there was click on the cancel button");
     ...
     *
     * @param car
     *            this is the car for which method finds out if it is in the table
     ...
     *
     * @param indexOfRow
     *            the index of rowin the table, starting from 0
     ...
     *
     * @param indexOfRow
     *            the index of row in the table, starting from 0
     */
     ...
     *
     * @param indexOfRow
     *            the row which will be checked in the popup
     */
     ...
     *
     * @param indexOfRow
     *            the row from which the menu will be called
     */
