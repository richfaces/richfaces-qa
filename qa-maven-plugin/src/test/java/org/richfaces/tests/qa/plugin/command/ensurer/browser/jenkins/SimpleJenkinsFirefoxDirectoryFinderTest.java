 ...
 */
public class SimpleJenkinsFirefoxDirectoryFinderTest {
    ...
    public void setUp() {
        ...
        finder = new SimpleJenkinsFirefoxDirectoryFinder();
    ...
    public void testHighest() {
        assertEquals(FF36, finder.getHighestVersion(new File[] { FF19, FF36, FF351, FF35111, FF10, FF24ESR, FF3501, FF35, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }));
    }

    @Test
    public void testHighest2() {
        assertEquals(FF35111, finder.getHighestVersion(new File[] { FF19, FF351, FF3501, FF35111, FF35, FF24ESR, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }));
    }

    @Test
    public void testHighestOrSpecific_existing() {
        assertEquals(FF36, finder.getHighestOrSpecificVersion(new File[] { FF19, FF36, FF351, FF35111, FF10, FF24ESR, FF3501, FF35, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("35")));
    }

    @Test
    public void testHighestOrSpecific_fromNonMatching_returnsNull() {
        assertEquals(null, finder.getHighestOrSpecificVersion(new File[] { BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("123")));
    }

    @Test
    public void testHighestOrSpecific_nonExistingSpecific_returnsHighest() {
        assertEquals(FF36, finder.getHighestOrSpecificVersion(new File[] { FF19, FF36, FF351, FF35111, FF10, FF24ESR, FF3501, FF35, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("112")));
    }

    @Test
    public void testHighest_NonExistiong_returnsNull() {
        assertEquals(null, finder.getHighestVersion(new File[] { BAD, BAD2, BAD3, BAD4 }));
    }

    @Test
    public void testOptimalOrMinimalVersion_optimalExists_returnsOptimal() {
        assertEquals(FF351, finder.getOptimalOrMinimalVersion(new File[] { FF19, FF36, FF351, FF35111, FF10, FF24ESR, FF3501, FF35, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("35.1"), Version.parseVersion("10")));
    }

    @Test
    public void testOptimalOrMinimalVersion_optimalExists_returnsOptimal2() {
        assertEquals(FF24ESR, finder.getOptimalOrMinimalVersion(new File[] { FF19, FF36, FF351, FF35111, FF10, FF24ESR, FF3501, FF35, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("24esr"), Version.parseVersion("19")));
    }

    @Test
    public void testOptimalOrMinimalVersion_optimalNotExistsMinimalExists_returnsMinimal() {
        assertEquals(FF10, finder.getOptimalOrMinimalVersion(new File[] { FF19, FF36, FF351, FF35111, FF10, FF24ESR, FF3501, FF35, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("34"), Version.parseVersion("10")));
    }

    @Test
    public void testOptimalOrMinimalVersion_optimalNotExistsMinimalNotExists_returnsNull() {
        assertEquals(null, finder.getOptimalOrMinimalVersion(new File[] { FF19, FF36, FF351, FF35111, FF10, FF24ESR, FF3501, FF35, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("34"), Version.parseVersion("11")));
    }

    @Test
    public void testSpecificOrHighest_existing() {
        assertEquals(FF351, finder.getSpecificVersionOrHighest(new File[] { FF19, FF36, FF351, FF35111, FF10, FF24ESR, FF3501, FF35, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("35.1")));
    }

    @Test
    public void testSpecificOrHighest_fromNonMatching_returnsNull() {
        assertEquals(null, finder.getSpecificVersionOrHighest(new File[] { BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("123")));
    }

    @Test
    public void testSpecificOrHighest_nonExistingSpecific_returnsHighest() {
        assertEquals(FF36, finder.getSpecificVersionOrHighest(new File[] { FF19, FF36, FF351, FF35111, FF10, FF24ESR, FF3501, FF35, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("112")));
    }

    @Test
    public void testSpecific_existing() {
        assertEquals(FF36, finder.getSpecificVersion(new File[] { FF19, FF36, FF351, FF35111, FF10, FF24ESR, FF3501, FF35, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("36")));
    }

    @Test
    public void testSpecific_existing2() {
        assertEquals(FF3501, finder.getSpecificVersion(new File[] { FF19, FF36, FF351, FF35111, FF10, FF24ESR, FF3501, FF35, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("35.0.1")));
    }
    ...
    public void testSpecific_fromNonMatching_returnsNull() {
        assertEquals(null, finder.getSpecificVersion(new File[] { BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("123")));
    }

    @Test
    public void testSpecific_nonExisting_returnsNull() {
        assertEquals(null, finder.getSpecificVersion(new File[] { FF19, FF36, FF351, FF35111, FF10, FF24ESR, FF3501, FF35, FF242ESR, FF242ESROLD, BAD, BAD2, BAD3, BAD4 }, Version.parseVersion("66")));
    }
}
