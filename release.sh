...
CONF="--batch-mode -Dtag=${RELEASE} -DreleaseVersion=${RELEASE} -DdevelopmentVersion=${DEVELOPMENT} -Dmaven.test.skip=true -Dselenium.test.skip=true -Dselenium.server.skip=true -DignoreSnapshots=true"
