 ...
 * @version $Revision$
 */
public class TestRegion extends AbstractShowcaseTest {
	...
	public void testFirstWrongSubmitUserNameAndEmail() {
		...
		typeSomethingToTwoInputsTestWhetherOuputIsEmpty(firstUserName, firstEmail, 
				firstEnteredName, firstEnteredEmail, firstWrongSubmit, true);
	}
	...
	public void testSecondRightSubmitUserNameAndEmail() {
		...
		typeSomethingToTwoInputsTestWhetherOuputIsEmpty(secondUserName, secondEmail, 
				secondEnteredName, secondEnteredEmail, secondRightSubmit, false);
	}
	...
	private void typeSomethingToTwoInputsTestWhetherOuputIsEmpty(JQueryLocator input1, JQueryLocator input2,
																JQueryLocator output1, JQueryLocator output2,
																JQueryLocator submit, boolean shouldBeEmpty) {
