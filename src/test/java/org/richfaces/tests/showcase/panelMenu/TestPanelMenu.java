 ...
 * @version $Revision$
 */
public class TestPanelMenu extends AbstractShowcaseTest {
	...
	/* ****************************************************************************
	 * Tests, relies on particular structure of panel menu, 
	 * dive only to the second level of that structure
	 ******************************************************************************/
