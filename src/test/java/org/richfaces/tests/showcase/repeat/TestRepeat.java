...
public class TestRepeat extends AbstractDataIterationWithStates {
	...
	private final StateWithCapitalAndTimeZone FIRST_STATE_FIRST_PAGE = new StateWithCapitalAndTimeZone(
			"Alabama", "Montgomery", "GMT-6");
	
	private final StateWithCapitalAndTimeZone LAST_STATE_FIRST_PAGE = new StateWithCapitalAndTimeZone(
	...
	private final StateWithCapitalAndTimeZone FIRST_STATE_THIRD_PAGE = new StateWithCapitalAndTimeZone(
			"South Dakota", "Pierre", "GMT-6");
	
	private final StateWithCapitalAndTimeZone LAST_STATE_THIRD_PAGE = new StateWithCapitalAndTimeZone(
	...
	private StateWithCapitalAndTimeZone retrieveDataAboutState(JQueryLocator header, JQueryLocator body) {
		...
		// since capitalAndTimeZone is in format State Capital (particular capital) State TimeZone (particular time zone) 
