 ...
 * @version $Revision$
 */
public class TestCompositemessages extends
		AbstractShowcaseTest {
	...
	public static final String ERROR_MESSAGE_NAME_LENGTH_TOO_SHORT_BUT_NOT_EMPTY = 
		"Name: Validation Error: Value is less than allowable minimum of '3'";
	
	public static final String ERROR_MESSAGE_NAME_TOO_LONG = 
		"Name: Validation Error: Value is greater than allowable maximum of '12'";
	
	public static final String ERROR_MESSAGE_NAME_EMPTY =
		"Name: Validation Error: Value is required.";
	
	public static final String ERROR_MESSAGE_ADDRESS_TOO_LONG =
		"Address: Validation Error: Value is greater than allowable maximum of '100'";
	
	public static final String ERROR_MESSAGE_ADDRESS_EMPTY = 
	...
	public void testDataAboutUserAreFilledCorrectly() {
		// minimal values
		fillUseDataCorrectlyAndCheckErrorMessages(
				LENGTH_OF_USER_NAME_CORRECT_BOTTOM_BORDER_VALUE,
				LENGTH_OF_ADDRESS_CORRECT_BOTTOM_BORDER_VALUE);

		// middle values
		fillUseDataCorrectlyAndCheckErrorMessages(
				LENGTH_OF_USER_NAME_CORRECT_MIDDLE_VALUE,
				LENGTH_OF_ADDRESS_CORRECT_MIDDLE_VALUE);

		// maximal values
		fillUseDataCorrectlyAndCheckErrorMessages(
				LENGTH_OF_USER_NAME_CORRECT_UPPER_BORDER_VALUE,
	...
	public void testUserNameFilledIncorrectlyMoreThan12() {
		...
		prepareStringBuildersClickOnTheButton(
				LENGTH_OF_USER_NAME_WRONG_TOO_LONG,
				LENGTH_OF_ADDRESS_CORRECT_MIDDLE_VALUE);
	...
	public void testUserNameFilledIncorrectlyLessThan3MoreThan0() {
		...
		prepareStringBuildersClickOnTheButton(
				LENGTH_OF_USER_NAME_WRONG_LESS_THAN_MINIMAL,
				LENGTH_OF_ADDRESS_CORRECT_MIDDLE_VALUE);
	...
	/**
	 * Fills in correct name and correct address and check error messages,
	 * lengths are for checking various length values and they should be
	 * asssigned correctly
	 * 
	 ...
	 */
	private void fillUseDataCorrectlyAndCheckErrorMessages(
			int lengthOfUserName, int lengthOfAddress) {
	...
	/**
	 * Fill in the user name and address according to the params and ten clicks
	 * on the button
	 * 
	 * @param lengthOfUserName
	 ...
	 */
	private void prepareStringBuildersClickOnTheButton(int lengthOfUserName,
			int lengthOfAddress) {
	...
	private void isUserSuccessfullyAddedPresent(boolean shouldBeElementPresent) {
		...
		if (shouldBeElementPresent) {
			...
			assertFalse(
					selenium.isElementPresent(userSuccessfullyAdded),
	...
	private void isErrorMessageStartingWithAddressPresent(boolean shouldBeElementPresent) {
		...
		if(shouldBeElementPresent) {
			assertTrue(selenium.isElementPresent(errorMessageStartWithAddress), "There should be an error message starting with " +
					"Adress");
		} else {
			assertFalse(selenium.isElementPresent(errorMessageStartWithAddress), "There should not be an error message starting with " +
					"Adress");
