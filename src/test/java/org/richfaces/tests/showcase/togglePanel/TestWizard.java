...
public class TestWizard extends AbstractShowcaseTest {
	...
	public void testStep1ValidationEmptyInputs() {
		...
		try {
			...
			isThereErrorMessage(errorMessage, ERROR_MSG_VALUE_REQUIRED, true);
		
		} catch ( SeleniumException ex ) {
			
			fail("The string containing just white spaces should be considered as empty string during validation!");
		}
	}
