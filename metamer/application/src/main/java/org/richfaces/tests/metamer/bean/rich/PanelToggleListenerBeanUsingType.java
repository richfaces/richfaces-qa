...
@ManagedBean
@SessionScoped
public class PanelToggleListenerBeanUsingType implements PanelToggleListener {

    public static final String MSG_TEMPLATE = "* panelToggleListener using @type invoked, panel {0}";
