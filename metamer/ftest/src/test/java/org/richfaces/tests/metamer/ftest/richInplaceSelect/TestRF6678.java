 ...
 */
@RegressionTest("https://issues.jboss.org/browse/RF-6678")
public class TestRF6678 extends AbstractWebDriverTest {

    private static final String DISABLED_CLASS = "rf-is-opt-dis";
    ...
    @FindByJQuery(value = "[class*=rf-is-opt]:visible")
    private List<WebElement> visibleSuggestions;

    @Override
    public String getComponentTestPagePath() {
        return "richInplaceSelect/rf-6678.xhtml";
    }
    ...
    public void testDisabledItemsCannotBeSelected() {
        ...
        // select some option
        Graphene.guardAjax(select).select(0);// fragment is working only with enabled items
    ...
    public void testDisabledItemsCannotBeSelectedWithJSAPI() {
        ...
        assertEquals(select.getTextInput().getStringValue(), "");
