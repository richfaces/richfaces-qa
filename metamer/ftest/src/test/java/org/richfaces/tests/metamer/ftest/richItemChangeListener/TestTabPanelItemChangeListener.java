...
public class TestTabPanelItemChangeListener extends AbstractItemChangeListenerTest {
    ...
    private final String ICL_inComponent_usingListener_PhaseName = "* itemChangeListenerBean2 item changed: null -> tab2";
    private final String ICL_outsideComponent_usingType_PhaseName = "* itemChangeListenerBean3 item changed: null -> tab2";
