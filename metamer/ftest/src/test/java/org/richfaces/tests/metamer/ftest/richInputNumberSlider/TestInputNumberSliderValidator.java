 ...
 */
public class TestInputNumberSliderValidator extends AbstractInputComponentValidatorTest {
    ...
    public String getComponentTestPagePath() {
        return "richInputNumberSlider/validator.xhtml";
    }

    @Override
    protected void setCorrectValue() {
        slider.setValue(VALID);
        // blur
