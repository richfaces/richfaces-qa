 ...
 */
public class TestInplaceInputValidator extends AbstractInputComponentValidatorTest {

    private static final String NOT_PHOENIX = "NOT_PHOENIX";
    ...
    public String getComponentTestPagePath() {
        return "richInplaceInput/validator.xhtml";
    }

    @Override
    protected void setCorrectValue() {
        Graphene.guardAjax(input.type(PHOENIX)).confirm();
    }

    @Override
    protected void setIncorrectValue() {
        Graphene.guardAjax(input.type(NOT_PHOENIX)).confirm();
    }
