...
public class AttributesImpl<T extends AttributeEnum> implements Attributes<T>, UnsafeAttributes {
    ...
    private ActionWrapper buildJSActionWrapper(final String event, final WebElement element) {
    ...
    private abstract static class SearchResult {
        ...
        private SearchResult(Tag tag, List<WebElement> elements) {
            this.tag = tag;
    ...
    private static class SingleElementSearchResult extends SearchResult {
        ...
        private SingleElementSearchResult(Tag tag, List<WebElement> elements) {
            super(tag, elements);
        }
