 ...
 */
@Templates("plain")
public class TestHSelectManyMenu extends AbstractAjaxTest {
    ...
    public String getComponentTestPagePath() {
        return "a4jAjax/hSelectManyMenu.xhtml";
    }
    ...
    public void performAction(String input) {
        Graphene.guardAjax(page.getSelectManyMenu()).selectByValue(input);
    }
    ...
    public void testDisabled() {
        ...
        Graphene.guardNoRequest(page.getSelectManyMenu()).selectByValue("Audi");
    }
