...
public class TestInputNumberSpinnerJSR303 extends AbstractNumberInputComponentValidationTest {
    ...
    public void testCustomBySpinning() {
        tests.verifyCustomBySpinning(getWait());
    }

    @Test
    public void testMaxBySpinning() {
        tests.verifyMaxBySpinning(getWait());
    }

    @Test
    public void testMinBySpinning() {
        tests.verifyMinBySpinning(getWait());
    }
}
