 ...
 */
public class TestCollapsibleSubTableKeepSaved extends AbstractAjocadoTest {

    private final JQueryLocator firstInput = pjq("input[type=text][id*=richSubTable]:first");
    ...
    public URL getTestUrl() {
        return buildUrl(contextPath, "faces/components/richCollapsibleSubTable/keepSaved.xhtml");
    }

    @Test
    public void testKeepSavedFalse() {
        selenium.type(firstInput, "a");
