...
import org.jboss.test.selenium.listener.FailureLoggingTestListenerWD;
 ...
 * @since 4.3.0.M1
 */
public class MetamerFailureLoggingTestListenerWD extends FailureLoggingTestListenerWD {
    @Override
