 ...
 */
public class TestCollapsiblePanelRF12977 extends AbstractWebDriverTest {

    @FindBy(css = "[id$=component]")
    private TextualRichFacesCollapsiblePanel cp;

    @Override
    public String getComponentTestPagePath() {
        return "richCollapsiblePanel/rf-12977.xhtml";
    }
