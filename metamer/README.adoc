...
=== Running a test
* switch to metamer/ftest directory and run +mvn clean verify -PprofileName -Dtest=testName -Dtemplates=templateName+
...
** templateName is one of the templates such as plain, richPanel, a4jRepeat, uiRepeat
*** default value is plain
*** you can use +-Dtemplates=*+ to run tests in all templates
