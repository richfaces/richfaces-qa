...
The sample and tests are accessible at https://github.com/richfaces/richfaces-qa/tree/eap[demo branch], https://github.com/richfaces/richfaces-qa/blob/eap/metamer/application/src/main/webapp/components/myComponent/sample1.xhtml[the sample], https://github.com/richfaces/richfaces-qa/blob/eap/metamer/ftest/src/test/java/org/richfaces/tests/metamer/ftest/myPackage/MyFirstTest.java[the test].
