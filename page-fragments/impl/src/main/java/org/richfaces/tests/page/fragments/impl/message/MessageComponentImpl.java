 ...
 */
public class MessageComponentImpl {
    ...
    private WebElement messageSummary;
    ...
    public ExpectedCondition<Boolean> isDetailVisibleCondition() {
        ...
        condition1 = Graphene.element(messageDetail).isVisible();
    ...
    public ExpectedCondition<Boolean> isSummaryVisibleCondition() {
        return Graphene.element(messageSummary).isVisible();
    }

    public ExpectedCondition<Boolean> isSummaryNotVisibleCondition() {
        return Graphene.element(messageSummary).not().isVisible();
    }
