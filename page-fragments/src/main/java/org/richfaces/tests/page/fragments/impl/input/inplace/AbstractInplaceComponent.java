 ...
 */
public abstract class AbstractInplaceComponent implements InplaceComponent {
    ...
    protected RichFacesInplaceComponentControls controls;

    @Override
    public RichFacesInplaceComponentControls getControls() {
        return controls;
    }
