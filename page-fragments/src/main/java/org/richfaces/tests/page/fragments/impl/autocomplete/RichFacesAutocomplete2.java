 ...
 */
public class RichFacesAutocomplete2 implements Autocomplete {
    ...
    public class AdvancedInteractions {
        ...
        public List<WebElement> getSuggestions() {
            return Collections.unmodifiableList(RichFacesAutocomplete2.this.getSuggestions());
        }
            ...
            Graphene.waitModel()
                ...
                .until(new Predicate<WebDriver>() {
                    ...
                    public boolean apply(WebDriver input) {
                        return RichFacesAutocomplete2.this.getSuggestions().isEmpty();
                    }
                });
        }
    ...
    public class SelectOrConfirmImpl implements SelectOrConfirm {
        ...
        public Autocomplete confirm() {
            actions.sendKeys(Keys.chord(Keys.SPACE, Keys.BACK_SPACE))
                .click(advanced().getRoot().findElement(By.xpath("//body")))
                .perform();
            advanced().waitForSuggestionsHide();
            return RichFacesAutocomplete2.this;
        }
