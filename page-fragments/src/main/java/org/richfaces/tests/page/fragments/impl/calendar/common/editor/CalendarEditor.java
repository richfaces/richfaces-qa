...
import org.richfaces.tests.page.fragments.impl.calendar.common.editor.time.TimeEditorImpl;
import org.richfaces.tests.page.fragments.impl.calendar.common.editor.yearAndMonth.YearAndMonthEditor;
import org.richfaces.tests.page.fragments.impl.calendar.common.editor.yearAndMonth.YearAndMonthEditorImpl;
...
public class CalendarEditor {
    ...
    private YearAndMonthEditorImpl dateEditor;
    @FindBy(css = "table[id$=TimeEditorLayout]")
    private TimeEditorImpl timeEditor;
