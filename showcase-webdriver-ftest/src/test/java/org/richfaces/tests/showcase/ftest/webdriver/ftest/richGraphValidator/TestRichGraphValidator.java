...
public class TestRichGraphValidator extends AbstractWebDriverTest {
    ...
    public void testConfirmation() {
        ...
        Graphene.waitAjax()
            ...
            .until(new WebElementConditionFactory(getPage().getGraphValidatorMessageArea()).isPresent());
        ...
        Graphene.waitAjax()
            ...
            .until(new WebElementConditionFactory(getPage().getInfoMessageArea()).isPresent());
    ...
    public void testLongPassword() {
        ...
        Graphene.waitAjax()
            ...
            .until(new WebElementConditionFactory(getPage().getValidatorMessageArea()).isPresent());
